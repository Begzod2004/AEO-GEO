...
export const en = {
  ...
  hero: {
    ...
    graphAria:
      "AEO.GEO connects your brand to AI answer engines: ChatGPT, Gemini, Claude, Perplexity and Copilot.",
  },
  email: {
  ...
  platforms: { label: "Monitors and optimizes for:" },
  story: {
    eyebrow: "From invisible to recommended",
    h2pre: "How your brand becomes",
    h2accent: "AI-visible",
    h2post: "",
    side: "Six steps from a website AI skips to a brand AI recommends.",
    steps: [
      {
  ...
  dash: {
    ...
    trendUp: "▲ trending up",
    trendAria:
      "Example trend chart: AI Visibility score rising from 22 to 81 across twelve scans.",
  },
  facts: {
    items: [
  ...
  pricing: {
    ...
    h2pre: "Founding-member",
    h2accent: "pricing",
    h2post: "",
    sub: "Lock in early-access rates before public launch. Cancel anytime.",
    popular: "Most popular",
    cta: "Get Early Access",
    note: "Early-access prices are placeholders and may change before public launch.",
    plans: [
      {
        name: "Starter",
        price: "$29",
  ...
  footer: {
    ...
    copyright: "© 2026 AEO.GEO. All rights reserved.",
    built: "Built to be read by humans and machines.",
  },
};
